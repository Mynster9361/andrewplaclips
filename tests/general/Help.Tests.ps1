...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\andrewplaclips\functions", "$global:testroot\..\andrewplaclips\internal\functions"),
	
	[string]
	$ModuleName = "andrewplaclips",
...
$CommandPath = @(
    "$global:testroot\..\andrewplaclips\functions"
    "$global:testroot\..\andrewplaclips\internal\functions"
)
